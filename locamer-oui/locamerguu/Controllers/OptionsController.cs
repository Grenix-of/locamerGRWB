...
namespace locamerguu.Controllers
{
    public class OptionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idOption,libelle,prixJour")] Option option)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idOption,libelle,prixJour")] Option option)
        {
            if (ModelState.IsValid)
            {
